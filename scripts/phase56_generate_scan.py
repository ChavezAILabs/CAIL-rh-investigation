...
# Scan n from 4950 to 5050 (101 points)
indices = list(range(4949, 5050))
vectors = []
...
for idx in indices:
    ...
    vectors.append({
        ...
        "energy": float(norm_sq(Fv))
    })

with open("phase56_density_scan_vectors.json", "w") as f:
    json.dump(vectors, f, indent=2)

print(f"Generated {len(vectors)} vectors for n=4950..5050.")
