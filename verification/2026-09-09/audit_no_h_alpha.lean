/- C-017 fix, hypothesis-use audit (standing check item 1).
   Scratch copy of chavez_transform_integrable with h_alpha DELETED from the
   signature. Result: FAILS -- unknown identifier `h_alpha` at the K_bound
   call site. h_alpha is load-bearing. -/
...
-- h_alpha DELETED
theorem chavez_transform_integrable_no_halpha
